...
>
    <div class="w-full flex items-center justify-between gap-4">
        <p class="text-gray-700 font-medium">Listado de ofertas proximas a expirar.</p>
    ...
    @if (count($jobOffers) > 0)
        <table class="w-full text-left text-sm">
            <thead class="border-b border-gray-400 text-sm text-on-surface-strong dark:border-outline-dark dark:bg-surface-dark-alt dark:text-on-surface-dark-strong">
                <tr>
            ...
            @foreach ($offers as $offer)
                <tbody class="divide-y divide-outline divide-gray-300 dark:divide-outline-dark overflow-hidden">
                    <tr>
                        ...
                        <td class="p-4">{{ $offer->jobTitle }}</td>
                        <td class="p-4 truncate">{{ $offer->description }}</td>
                        <td class="p-4">
