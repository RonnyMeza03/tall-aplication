        ...
        <form wire:submit.prevent="submit" class="px-4 py-5 sm:p-6 dark:bg-gray-800">
            ...
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input type="file" wire:model="logo" id="logo" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    </div>
