<aside class="w-64 bg-gray-800 text-white p-4 flex flex-col h-screen overflow-y-auto">
    ...
    <nav class="flex-grow">
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{route('MyTeam')}}" wire:navigate class="flex items-center p-2 rounded hover:bg-gray-700 transition">
                    <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li>
                <a href="{{route('calendar')}}" wire:navigate class="flex items-center p-2 rounded hover:bg-gray-700 transition">
                    <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
